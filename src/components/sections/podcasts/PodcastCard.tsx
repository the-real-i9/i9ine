...
function PodcastCard(p: Props) {
  return (
    <div className="podcast-card group w-[590px] flex p-2 max-h-40 space-x-2 bg-bgray-800 rounded-2xl hover:shadow-[0px_4px_4px] hover:shadow-black/25 hover:-translate-y-1 transition-transform">
      <img
        className="podcast-pic w-64 aspect-video rounded-xl"
        src={p.thumbnail}
      />
